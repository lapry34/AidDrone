...
//#define EXTENDED_AUX_STATES
  ...
  /**************************************************************************************/
    ...
    /****************************    PPM Sum Reciver    ***********************************/
      ...
      //#define SERIAL_SUM_PPM         ROLL,PITCH,YAW,THROTTLE,AUX1,AUX2,AUX3,AUX4,8,9,10,11 //QUELLO DEL GIROSCOPIO
 ...
 */
  ...
  /**************************************************************************************/
    ...
    #define GPS_SERIAL 4         // should be 2 for flyduino v2. It's the serial port number on arduino MEGA
